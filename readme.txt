...
= Why does the heading of some templates say {orderid} or {orderdate}, will the emails also say {orderid} =

I am working on this feature, the actual emails are populated with correct data
